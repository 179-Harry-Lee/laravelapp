...
<head>        
        ...
        <!-- Mobile Menu -->
        <link href="{{('frontend/css/mmenu.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{('frontend/css/mmenu.positioning.css')}}" rel="stylesheet" type="text/css" />
    ...
    <body>
                            ...
                            <div class="col-md-3">
                                <div class="navbar-header">
                                    <div class="navbar-brand">
                                        <h1>
                                            <a href="index-2.html">
                                                <img src="{{('frontend/images/libraria-logo-v1.png')}}" alt="LIBRARIA" />
                                            </a>
                                        </h1>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-9">
                                               ...
                                               echo '<a href="/login"><i class="fa fa-lock"></i>Login / Register</a>';
                                                ...
                                                <div class="header-cart dropdown">
                                                    ...
                                                    <div class="dropdown-menu cart-dropdown">
                                                        <ul>
                                                            <li class="clearfix">
                                                                <img src="{{('frontend/images/header-cart-image-0.jpg')}}" alt="cart item" />
                                                                <div class="item-info">
                                                                    <div class="name">
                                ...
                                if($permission == 1){
                                    ...
                                    <ul class="nav navbar-nav">
                                        <li class="dropdown active">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="{{URL::asset("/trangchu")}}">Home</a>
                                        ...
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="news-events-list-view.html">Upload books</a>
                                            <ul class="dropdown-menu">
                                ...
                                echo '
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="books-media-list-view.html">Hi</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="books-media-list-view.html">Books &amp; Media List View</a></li>
                                                <li><a href="books-media-gird-view-v1.html">Books &amp; Media Grid View V1</a></li>
                                                <li><a href="books-media-gird-view-v2.html">Books &amp; Media Grid View V2</a></li>
                                        ...
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="news-events-list-view.html">Hi</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="news-events-list-view.html">News &amp; Events List View</a></li>
                                                <li><a href="news-events-detail.html">News &amp; Events Detail</a></li>
                                            </ul>
            ...
            <div class="container">
                ...
                <div class="team-list">
                    <div class="team-member">
                        <figure>
                            <img src="{{('frontend/images/team-img-01.jpg')}}" alt="team" />
                        </figure>
                    ...
                    <div class="team-member">
                        <figure>
                            <img src="{{('frontend/images/team-img-02.jpg')}}" alt="team" />
                        </figure>
                        <div class="content-block">
                            <div class="member-info">
                    ...
                    <div class="team-member">
                        <figure>
                            <img src="{{('frontend/images/team-img-03.jpg')}}" alt="team" />
                        </figure>
                        <div class="content-block">
                            <div class="member-info">
                                <h4>Anna Delpan</h4>
                ...
                <div class="tabs-container">
                    ...
                    <div class="tabs-list">
                        <div class="tab-content active">
                            <article>
                                <figure>
                                    <img src="{{('frontend/images/latest-blog-img-home-v1.jpg')}}" alt="Latest Blog">
                                    <figcaption>
                                        <a href="#.">
                        ...
                        <div class="tab-content">
                            <article>
                                <figure>
                                    <img src="{{('frontend/images/latest-blog-img-home-v1-2.jpg')}}" alt="Latest Blog">
                                    <figcaption>
                                        <a href="#.">
                ...
                <div class="owl-carousel">
                    <div class="single-testimonial-box">
                        <div class="top-portion">
                            <img src="{{('frontend/images/testimonial-image-01.jpg')}}" alt="Testimonial Image" />
                    ...
                    <div class="single-testimonial-box">
                        <div class="top-portion">
                            <img src="{{('frontend/images/testimonial-image-02.jpg')}}" alt="Testimonial Image" />
                            <div class="user-comment">
                                <div class="arrow-left"></div>
                                <blockquote cite="#">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent urna magna, rhoncus eget commodo et, dignissim non nulla. Sed sit amet vestibulum ex. Donec dolor velit
            ...
            <div class="container">
                ...
                <div class="news-events-list">
                    <div class="single-news-event">
                        <figure>
                            <img src="{{('frontend/images/news-event/news-event-01.jpg')}}" alt="News & Event" />
                        </figure>
                        <div class="content-block">
                            <div class="member-info">
                    ...
                    <div class="single-news-event">
                        <figure>
                            <img src="{{('frontend/images/news-event/news-event-02.jpg')}}" alt="News & Event" />
                        </figure>
                        <div class="content-block">
                            <div class="member-info">
                                <div class="content_meta_category">
                    ...
                    <div class="single-news-event">
                        <figure>
                            <img src="{{('frontend/images/news-event/news-event-03.jpg')}}" alt="News & Event" />
                        </figure>
                        <div class="content-block">
                            <div class="member-info">
                                <div class="content_meta_category">
        ...
        <!-- Mobile Menu -->
        <script type="text/javascript" src="{{('frontend/js/mmenu.min.js')}}"></script>
        
        <!-- Harvey - State manager for media queries -->
        <script type="text/javascript" src="{{('frontend/js/harvey.min.js')}}"></script>
        
        <!-- Waypoints - Load Elements on View -->
        <script type="text/javascript" src="{{('frontend/js/waypoints.min.js')}}"></script>

        <!-- Facts Counter -->
        <script type="text/javascript" src="{{('frontend/js/facts.counter.min.js')}}"></script>

        <!-- MixItUp - Category Filter -->
        <script type="text/javascript" src="{{('frontend/js/mixitup.min.js')}}"></script>

        <!-- Owl Carousel -->
        <script type="text/javascript" src="{{('frontend/js/owl.carousel.min.js')}}"></script>
        
        <!-- Accordion -->
        <script type="text/javascript" src="{{('frontend/js/accordion.min.js')}}"></script>
        
        <!-- Responsive Tabs -->
        <script type="text/javascript" src="{{('frontend/js/responsive.tabs.min.js')}}"></script>
        
        <!-- Responsive Table -->
        <script type="text/javascript" src="{{('frontend/js/responsive.table.min.js')}}"></script>
        
        <!-- Masonry -->
        <script type="text/javascript" src="{{('frontend/js/masonry.min.js')}}"></script>
        
        <!-- Carousel Swipe -->
        <script type="text/javascript" src="{{('frontend/js/carousel.swipe.min.js')}}"></script>
